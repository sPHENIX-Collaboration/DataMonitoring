...
# events
strembed0="DST_TRUTH_G4HIT_single_pi_"$low"_"$high"MeV_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000006-0000"$fileno".root"
strembed1="DST_TRKR_G4HIT_single_pi_"$low"_"$high"MeV_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000006-0000"$fileno".root"
strembed2="DST_CALO_G4HIT_single_pi_"$low"_"$high"MeV_sHijing_0_20fm_50kHz_bkg_0_20fm-0000000006-0000"$fileno".root"
